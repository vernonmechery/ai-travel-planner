...
Bedrock Model Access - NovaPro in us-west-2
...
aws ecr create-repository --repository-name ai_travel_planner --region us-west-2   [provide your repo name in place of ai_travel_planner]
# Login to ECR
...
docker buildx build --platform linux/arm64 -t 196715057542.dkr.ecr.us-west-2.amazonaws.com/ai_travel_planner:latest --push .
